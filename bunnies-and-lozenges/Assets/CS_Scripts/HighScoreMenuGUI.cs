// handles showing high score information (entire GUI)

using UnityEngine;
using System.Collections;

public class HighScoreMenuGUI : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (GUILayout.Button("Play Again!")) // creates and listens to mouse press
			OpenLevel("Game");
